            ...
            <div className="flex items-center justify-between h-16">
                <div className="w-full justify-between flex items-center">
                    <Link className="flex-shrink-0 cursor-pointer" href="/">
                        <Image src={LogoTrans} width={150} height={150} alt="Classic Coast Logo" />
                    </Link>
                        ...
                        <div className="ml-10 flex items-baseline space-x-11">
                            ...
                            <Link className="text-gray-300  hover:text-gray-800 dark:hover:text-white px-3 py-2 rounded-md text-sm font-medium" href="/how_section">
                                How it works
                            </Link>
                            <Link className="text-gray-300  hover:text-gray-800 dark:hover:text-white px-3 py-2 rounded-md text-sm font-medium" href="/#">
